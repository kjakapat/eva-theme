...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#2a3b4d', '#c4676c', '#66ff66', '#ffff66', '#15f4ee', '#9c6cd3', '#4b8f77', '#9fa2a6', '#47698c', '#ff9966', '#354e67', '#3f5c7b', '#758ba2', '#d6d7d9', '#bb64a9', '#ffffff']"
...
gset string palette "['#2a3b4d', '#c4676c', '#66ff66', '#ffff66', '#15f4ee', '#9c6cd3', '#4b8f77', '#9fa2a6', '#47698c', '#ff9966', '#354e67', '#3f5c7b', '#758ba2', '#d6d7d9', '#bb64a9', '#ffffff']"
