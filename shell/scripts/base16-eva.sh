...
color08="47/69/8c" # Base 03 - Bright Black
...
color18="2f/43/59" # Base 01
color19="36/50/6a" # Base 02
color20="75/8b/a2" # Base 04
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pj 36506a # selection color
